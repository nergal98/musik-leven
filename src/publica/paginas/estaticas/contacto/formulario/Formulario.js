...
export default class Formulario extends Component {
  ...
  validateAll = () => {
    ...
    const mensajesValidacion = Object.values(validations).filter(
  ...
  validateNombre = (name) => {
    ...
    return validadorNombre
      ...
      .isLength(50, "La longitud de nombre no es correcta (max 50)").result;
  };
  ...
  validateEmail = (name) => {
    ...
    return validadorEmail
      ...
      .isEmail("Formato email incorrecto").result;
  };
  ...
  validateAsunto = (name) => {
    ...
    return validadorAsunto
      ...
      .isLength(50, "La longitud de asunto no es correcta (max 100)").result;
  };
  ...
  validateMensaje = (name) => {
    ...
    return validadorMensaje
      ...
      .isLength(200, "La longitud de mensaje no es correcta (max 200)").result;
  };
